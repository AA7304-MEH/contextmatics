                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    {user && (
                        <div className="flex items-center space-x-4">
                            ...
                            <button 
                                onClick={logout} 
                                className="px-4 py-2 text-sm font-semibold bg-indigo-100 text-indigo-700 rounded-lg hover:bg-indigo-200 dark:bg-slate-700 dark:text-white dark:hover:bg-slate-600 transition-colors"
                            >
                                Logout
                            </button>
                        </div>
