            ...
            <div className="container mx-auto px-6 py-12">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-10 animate-fade-in">
                    <div className="relative flex-1">
                        <input
                            ...
                            className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-11 pr-4 text-sm text-white focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all placeholder:text-[var(--color-text-muted)]"
                        />
                        ...
                        {CATEGORIES.map(cat => (
                            <button
                                ...
                                className={`px-4 py-2.5 rounded-xl text-sm font-medium transition-all border whitespace-nowrap ${selectedCategory === cat.id
                                    ? 'border-blue-500/40 bg-blue-500/10 text-white shadow-[0_0_15px_rgba(59,130,246,0.1)]'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 animate-fade-in">
                    {filteredTemplates.map((template, i) => (
                        <div
                            key={template.id}
                            className="group card relative overflow-hidden rounded-2xl border border-white/5 bg-[var(--color-background-surface)]/50 p-6 flex flex-col transition-all duration-300 hover:border-white/15 hover:-translate-y-1 hover:shadow-xl"
                        ...
                        >
                            ...
                            <div className="flex gap-3 mt-auto">
                                <button
                                    ...
                                    className="btn flex-1 justify-center py-2.5 text-sm font-semibold bg-gradient-to-r from-blue-600 to-violet-600 text-white rounded-xl border-none hover:shadow-lg hover:shadow-blue-500/20 transition-all"
                                >
                                    Use Template ✨
                                </button>
                                <button
                                    ...
                                    className="btn py-2.5 px-3 text-sm border border-white/10 bg-white/5 text-[var(--color-text-secondary)] hover:text-white hover:bg-white/10 rounded-xl transition-all"
                                    title="Copy prompt"
                                >
                                    📋
                                </button>
