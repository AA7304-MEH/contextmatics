    ...
    return (
        <header className="relative flex flex-col items-center text-center gap-8 mb-32 pt-20">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                <button onClick={() => navigate('/auth')} className="btn btn-primary text-lg px-8 py-3.5 bg-gradient-to-r from-blue-600 to-violet-600 border-none shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-all">
                    Start Creating Free →
                </button>
                <button onClick={() => navigate('/pricing')} className="btn btn-secondary text-lg px-8 py-3.5">
                    View Plans
                </button>
            </div>
        ...
        <footer className="border-t border-white/5 py-16 text-sm">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10 text-[var(--color-text-secondary)]">
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li><button onClick={() => navigate('/content-creator')} className="hover:text-white transition-colors">Content Creator</button></li>
                        <li><button onClick={() => navigate('/video-generator')} className="hover:text-white transition-colors">Video Generator</button></li>
