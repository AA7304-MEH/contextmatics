...
async function repurposeHandler(req: NextRequest, { deductCredits }: any) {
    ...
    try {
        const result = await ollamaService.chat(aiPrompt, "You are a professional content repurposing assistant. Output only the repurposed content.");
