                ...
                <div className="text-left">
                    ...
                    {showConfirmClear && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
                            <div className="card p-8 max-w-sm mx-auto border border-white/10 bg-[var(--color-bg-surface)]">
                    ...
                    {filteredItems.length === 0 && (
                        <div className="card p-16 border border-white/5 bg-white/5 text-center animate-fade-in">
                    ...
                    <div className="grid grid-cols-1 gap-3 animate-fade-in">
                        {filteredItems.map((item, index) => (
                            <div
                                ...
                                className="card group relative rounded-2xl border border-white/5 bg-white/5 overflow-hidden cursor-pointer transition-all hover:border-white/10"
                            ...
                            >
                                ...
                                {expandedId === item.id && (
                                    <div className="px-5 pb-5 pt-0 border-t border-white/5 animate-fade-in relative z-10">
                                        <div className="mt-4 bg-black/30 rounded-xl p-5 border border-white/5 max-h-[400px] overflow-y-auto overflow-x-hidden">
                                            {item.format === 'Logo' ? (
