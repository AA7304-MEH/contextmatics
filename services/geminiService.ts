...
export const generateContent = async (content: string, format: string): Promise<string> => {
    ...
    try {
        ...
        throw new Error("AI Content Generation failed. Please check your API key or try again later.");
    }
};
